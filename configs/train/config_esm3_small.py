...
config = {
    ...
    "encoder_args"      : {
        "hla_emb_path_s" : emb_path("esm_large/emb_hla_esm3_small_2408_0430.h5"),
        "epi_emb_path_s" : emb_path("esm_large/emb_epi_esm3_small_2408_0430.h5"),
