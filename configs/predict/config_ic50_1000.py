...
config["Test"]["chkp_path"] = _os.path.join(_os.path.dirname(_os.path.dirname(_os.path.dirname(_os.path.abspath(__file__)))), "models/prepibind_ic50_1000_s42_f1_fp16.pt")
