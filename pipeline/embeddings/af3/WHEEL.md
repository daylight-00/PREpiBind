...
network access at configure time. If that is inconvenient, the same commit builds to one wheel:
...
No copy is distributed: the wheel is not in this repository and not in the data deposit. The
checksum identifies our build; the recipe below is how to make one.
...
Build recipe:
    ...
    git clone https://github.com/daylight-00/alphafold3 && cd alphafold3 && git checkout f1b872e7
