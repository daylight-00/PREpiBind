...
def init_client():
    ...
    client = ESM3ForgeInferenceClient(
        ...
        url="https://forge.evolutionaryscale.ai",   # 307-redirects to biohub.ai since the 2026 move
        token=os.environ["ESM_FORGE_TOKEN"],   # keys now issued at biohub.ai/developer-console/api-keys
    )
